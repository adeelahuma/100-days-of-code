...
My goal is to start by refreshing concepts in python language, jumping into python data analysis libraries then revising ML algorithms and implementing them using different datasets. I am going to think about projects along the way. 

Lets Rock On!!!

I am going to refer following books to begin with:
